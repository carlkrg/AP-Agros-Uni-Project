...
class Group01:
    ...
    def plot_area_chart2(self, country: Optional[str] = None, normalize: bool = False, optional: Optional[str] = None) -> None:
            """
            Plots an area chart of the distinct "_output_" columns for the given country or all
            countries if `country` is set to "World" or None. The columns are normalized by the total
            output if the `normalize` parameter is set to True.
    ...
    def gapminder2(self) -> None:
            ...
            year : int
                The year for which to visualize the data.
                The user is asked for input the year if the function is
                calling empty parameters inside the brackets.
            log_scale : bool
                If True, the x and y axis will be displayed in logarithmic scale.
                The user is asked for input in form of y or n. The y stands for yes
                and set the boolen to True what means the function will use the log scale
                for the gapminder. If the input it n what stands for no the boolean will
                set to False and the function will not use the log scale.
                The brackets of the function has to be empty.
            Raises:
            TypeError
                If the received argument is not an int or if it's negative.
            ValueError
